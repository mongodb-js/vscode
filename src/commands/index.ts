export const ExtensionCommand = {
  ...
  MDB_FIX_THIS_INVALID_INTERACTIVE_SYNTAX:
  ...
  MDB_CHANGE_DRIVER_SYNTAX_FOR_EXPORT_TO_LANGUAGE:
  ...
  MDB_DISCONNECT_FROM_CONNECTION_TREE_VIEW:
  ...
  MDB_COPY_DOCUMENT_CONTENTS_FROM_TREE_VIEW:
