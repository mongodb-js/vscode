...
export const mergeSecrets = (
  ...
  const connectionInfoWithSecrets = cloneDeep(connectionInfo);
...
export const extractSecrets = (connectionInfo: Readonly<ConnectionInfo>): {
  connectionInfo: ConnectionInfo;
  secrets: ConnectionSecrets;
} => {
  const connectionInfoWithoutSecrets = cloneDeep(connectionInfo);
