...
describe('Resources Panel Component Test Suite', () => {
  describe('when rendered', () => {
    ...
    test('when a trusted link is clicked it sends an event to the extension', () => {
      ...
      assert.strictEqual(fakeVscodeWindowPostMessage.firstCall.args[0].linkTo, 'https://mongodb.com/products/vs-code/vs-code-atlas-signup?utm_campaign=vs-code-extension&utm_source=visual-studio&utm_medium=product&ajs_aid=mockAnonymousID');
