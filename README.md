...
| `mdb.useClassicDataBrowsingExperience` | Use the classic, editor-based experience to view collection documents and playground query results instead of the webview-based data browser. | `false` |
